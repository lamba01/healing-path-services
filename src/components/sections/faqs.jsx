    ...
    <section className="bg-white py-20 px-6 lg:px-10">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 lg:gap-20 items-start">
        ...
        <div className="space-y-5 md:sticky md:top-28">
          ...
          <h2 className="text-olive text-3xl sm:text-4xl font-bold leading-snug">
            Frequently asked questions
          </h2>
          <div className="w-12 h-1 bg-coral rounded" />
          <p className="text-gray-500 text-base leading-relaxed">
            Have questions about therapy or how it works? We have answered
            some of the most common ones below. If you don&apos;t see your
            question here, feel free to reach out — we are happy to help.
          </p>
        </div>
          ...
          {faqs.map((faq, index) => (
            <div
              ...
              <button
                ...
                <span className={`text-coral text-xl font-light transition-transform duration-300 ${openIndex === index ? 'rotate-45' : ''}`}>
                  +
                </span>
              </button>

              <div className={`transition-all duration-300 overflow-hidden ${openIndex === index ? 'max-h-60' : 'max-h-0'}`}>
